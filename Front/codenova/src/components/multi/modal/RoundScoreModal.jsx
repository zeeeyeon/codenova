...
const RoundScoreModal = ({ visible, scores, round, countdown }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      <div
        className="relative w-[800px] h-[570px] bg-center bg-contain bg-no-repeat flex flex-col items-center justify-start pt-[7rem] px-10 "
      ...
      >
        ...
        <div className="mt-auto pb-32 text-center text-yellow-400  drop-shadow text-xl">
